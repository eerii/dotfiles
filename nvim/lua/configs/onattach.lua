return function(client, bufnr)
    ...
    map({ "n", "v" }, "ga", vim.lsp.buf.code_action, opts "LSP Code action")

    map("n", "gd", function() require("trouble").toggle("lsp_definitions") end, opts "LSP Go to definition")
    map("n", "gt", function() require("trouble").toggle("lsp_type_definitions") end, opts "LSP Go to type definition")
    ...
    map("n", "<leader>wl", function() print(vim.inspect(vim.lsp.buf.list_workspace_folders())) end,
        opts "LSP List workspace folders")

    map("n", "<C-r>", function() require "nvchad.lsp.renamer" () end, opts "LSP Rename")
