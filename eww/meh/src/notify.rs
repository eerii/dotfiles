...
use std::{error::Error, sync::{atomic::{AtomicU32, Ordering}, mpsc::Sender, Arc, RwLock}, time::{Duration, SystemTime, UNIX_EPOCH}, fmt};
...
impl Manager {
    pub fn init() -> Self {
        Self { notifications: Arc::new(RwLock::new(Vec::new())) }
    }
